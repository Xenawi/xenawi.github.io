...
let /** {NodleElement} */ [lastActiveTab] = document.querySelectorAll("[data-tab-content]");
let /** {NodleElement} */ [lastActiveTabBtn] = $tabBtn;
...
$tabBtn.forEach(item =>{
    item.addEventListener("click", function(){
        ...
        const /** {NodleElement} */ $tabContent = document.querySelector(`[data-tab-content="${item.dataset.tabBtn}"]`);
